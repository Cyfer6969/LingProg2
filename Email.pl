...
open (CONFIGFILE, "<$configFile") or die "O Arquivo de configuracao n foi aberto com sucesso $!" ;
while(<CONFIGFILE>)
{
...
open(EMAILFILE, "<$emailFile") or die "O Arquivo do e-mail nao foi aberto com sucesso $!" ;
